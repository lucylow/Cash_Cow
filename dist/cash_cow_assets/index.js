...
/***/ "./src/declarations/cash_cow/cash_cow.did.js":
/*!***************************************************!*\
  !*** ./src/declarations/cash_cow/cash_cow.did.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/declarations/cash_cow/index.js":
/*!********************************************!*\
  !*** ./src/declarations/cash_cow/index.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "idlFactory": () => (/* reexport safe */ _cash_cow_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory),
/* harmony export */   "canisterId": () => (/* binding */ canisterId),
/* harmony export */   "createActor": () => (/* binding */ createActor),
/* harmony export */   "cash_cow": () => (/* binding */ cash_cow)
/* harmony export */ });
...
/* harmony import */ var _cash_cow_did_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./cash_cow.did.js */ "./src/declarations/cash_cow/cash_cow.did.js");
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./cash_cow.did.js")._SERVICE>}
 */
 const createActor = (canisterId, options) => {
  ...
  return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(_cash_cow_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory, {
    agent,
    canisterId,
...
/**
 * A ready-to-use agent for the cash_cow canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./cash_cow.did.js")._SERVICE>}
 */
 const cash_cow = createActor(canisterId);
...
"use strict";
/*!******************************************!*\
  !*** ./src/cash_cow_assets/src/index.js ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _declarations_cash_cow__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../declarations/cash_cow */ "./src/declarations/cash_cow/index.js");



window.addEventListener("load", async function() {
  // console.log("Finished loading cash cows");
  const currentAmount = await _declarations_cash_cow__WEBPACK_IMPORTED_MODULE_0__.cash_cow.checkBalance();
...
document.querySelector("form").addEventListener("submit", async function(event) {
  ...
  if (document.getElementById("input-amount").value.length != 0){
      await _declarations_cash_cow__WEBPACK_IMPORTED_MODULE_0__.cash_cow.topUp(inputAmount);
  };
